...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      'bg-primary text-primary-foreground hover:bg-primary-dark shadow-lg hover:shadow-xl hover:shadow-primary/25',
    secondary: 'bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-md',
    outline:
      'border border-border bg-transparent hover:bg-primary/10 text-foreground hover:text-primary hover:border-primary/50 transition-all',
