...
export const CardHeader: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  return <div className={`px-6 py-4 border-b border-border bg-muted/10 ${className}`}>{children}</div>;
};
...
export const CardFooter: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  return <div className={`px-6 py-4 border-t border-border bg-muted/10 ${className}`}>{children}</div>;
};
